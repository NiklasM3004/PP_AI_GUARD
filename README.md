...
Tec-Skills to demonstrate with files/paths referenced:
...
creating a simple HTML Page and defining a run command via package.json
Creating User Sign-Up, Login, Auth via AWS Cognito
Setting Up MongoDB, via Docker-Compose
Setting Up Backend- and Frontend-Side of Websockets Server, managing Websockets Handshake and using tenant- and session_id inside Backend, Frontend and Chrome-Extension
